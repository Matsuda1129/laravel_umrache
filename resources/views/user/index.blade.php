<x-app-layout>
    <x-slot name="header">
        ...
        <form method="get" action="{{ route('user.items.index') }}">
            <div class="lg:flex lg:justify-around">
                <div class="ls:flex items-center">
                    <select name="category" class="mb-4  lg:mr-2">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <a href="{{ route('user.items.show',['item' => $product->id])}}">
                                <div class="border rounded-md p-2 mb:p-4">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <p class="mt-1">{{ number_format($product->price) }}
                    ...
                    'pagination' => \Request::get('pagintaion '),
                    ])->links() }}
                </div>
            </div>
        </div>
    ...
    select.addEventListener('change', function(){
        ...
        const pagenate = document.getElementById('pagination')
