...
<div class="modal micromodal-slide" id="{{ $modal }}" aria-hidden="true">
    <div class="modal__overlay z-50" tabindex="-1" data-micromodal-close>
        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="{{ $modal }}-title">
            ...
            <main class="modal__content" id="{{ $modal }}">
                    ...
                    <div class="w-1/4 p-2 mb:p-4">
                        <div class="border rounded-md p-2 mb:p-4">
                            <img class="image" data-id="{{ $name }}_{{ $image->id }}" data-file="{{ $image->filename }}"
                                {{-- data-id2="{{ $iamge->id}}" --}} {{-- data-name="{{ $name}}" --}}
...
<div class="flex justify-around items-center mb-4">
    <a class="py-2 py-4 bg-gray-200" data-micromodal-trigger="{{ $modal }}" href='javascript:;'>ファイルを選択</a>
    <div class="w-1/4">
